...
class PaymentProcessor:
    ...
    def __init__(self, vault_public_key_pem: bytes | None=None):
        ...
        try:
            ...
            _ephemeral = rsa.generate_private_key(public_exponent=65537, key_size=4096, backend=default_backend())
    ...
    def encrypt_card_data(self, card: CardData) -> dict[str, str]:
        ...
        encrypted_pan = self._vault_public_key.encrypt(pan_bytes, padding.OAEP(mgf=padding.MGF1(algorithm=hashes.SHA256()), algorithm=hashes.SHA256(), label=None))
